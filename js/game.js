    ...
    var interval = null;
    var currentscore = 0;
    var currentName = window.prompt("Введите ваше имя", "mr. Smith");
    var recordUser = null;
    var highscore = null;
    ...
    document.querySelector(".current-user").innerHTML = currentName;
    document.querySelector(".record-user").innerHTML = recordUser;
